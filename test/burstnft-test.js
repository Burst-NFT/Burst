...
contract('BurstNFT', (accounts) => {
  ...
  it('should create BurstNFT correctly', async () => {
    ...
    await BurstNFTInstance.createBurstWithMultiErc20(
      [ TestToken1.address ],
      [ TestToken1Amount ],
      "Qmbp325JKQkpqzrMfJzpPx9YVzRcuhBnd7zVJTrpwsHGES"
    );
  ...
  it('should transfer a BurstNFT and destory BurstNFT correctly', async () => {
    //deploy BurstNFT contract
    const BurstNFTInstance = await BurstNFT.deployed();
    ...
    await BurstNFTInstance.destroyBurstWithMultiERC20(0, { from: accounts[1] });
